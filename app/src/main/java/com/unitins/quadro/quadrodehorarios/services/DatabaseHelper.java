...
public class DatabaseHelper extends SQLiteOpenHelper {
     ...
     */
    private static String DBPATH = "/data/data/com.unitins.quadro.quadrodehorarios/databases/";

    // Este é o nome do banco de dados que iremos utilizar
    private static String DBNAME = "AlocacaoBD.db";
    ...
    private void copyDatabase() throws IOException {
        ...
        InputStream dbInputStream = context.getAssets().open("AlocacaoBD.db");
